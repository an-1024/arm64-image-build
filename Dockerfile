...
RUN set -eux; \
    ...
    install_yum() { \
        ...
        yum install -y --allowerasing --exclude='glibc-common*' ca-certificates bash coreutils findutils grep sed curl wget tar gzip xz make gcc gcc-c++ perl \
